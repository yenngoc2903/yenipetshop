...
<body>
  ...
  <?php
    ...
    $sql_pro = "SELECT * FROM giongloai,loaithucung WHERE giongloai.maLoai=loaithucung.maLoai AND
                (   giongloai.tenGiong LIKE '%".$tukhoa."%'
                    OR loaithucung.tenLoai LIKE '%".$tukhoa."%'
                    OR giongloai.maGiong LIKE '%".$tukhoa."%' )";
      ...
      <tr>
        ...
        <td>
          <div class="quanly_table-action">
            <a href="xuly.php?magiong=<?php echo $row['maGiong'] ?>">Xoá</a>
